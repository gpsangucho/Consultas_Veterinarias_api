"""
Django settings for consultas_veterinarias project.
...
SECRET_KEY = 'django-insecure-sevs=@fo0_k^3y&ra3)7$$w^lvt^t1n=a#tg^2@dg^zh+^usbz'
...
ROOT_URLCONF = 'consultas_veterinarias.urls'
...
WSGI_APPLICATION = 'consultas_veterinarias.wsgi.application'
...
DATABASES={
  'default':{
    ...
    'NAME':os.getenv('DB_NAME','veterinariodb'),
